...
function App() {
  const [mensajes, setMensajes] = useState<Mensaje[]>([
    { 
     id: 1, 
      rol: 'agente', 
      texto: 'Hola, soy Baymax, tu asistente médico personal. ¿En una escala del 1 al 10, cómo calificarías tu dolor?' 
    },
    { 
      id: 2, 
      rol: 'usuario', 
    ...
    { 
      id: 3, 
      rol: 'agente', 
      texto: 'Basándome en tus síntomas, te recomiendo acudir a Urgencias o a un Cardiólogo lo antes posible. Con tu Plan Plata, estas son tus mejores opciones en la red:',
      hospitales: [
        {
          id: "h001",
        ...
        <div className="w-full max-w-3xl space-y-6">
          ...
          {mensajes.map((msg) => (
            ...
            >
              ...
              <div className={`border p-4 shadow-sm max-w-[85%] leading-relaxed 
                ${msg.rol === 'usuario' 
