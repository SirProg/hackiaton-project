...
const planesDisponibles = [
  {
    id: 1,
    nombre: "Plan Básico",
    desc: "Deducible alto, ideal para imprevistos mayores.",
    copagoEj: "$80 general",
  ...
  },
  {
    id: 2,
    nombre: "Plan Plata",
    desc: "Equilibrio entre prima mensual y costos de bolsillo.",
    copagoEj: "$50 general",
  ...
  },
  {
    id: 3,
    nombre: "Plan Oro",
    desc: "Menor deducible, mayor cobertura en especialistas.",
    copagoEj: "$30 general",
  ...
  },
  {
    id: 4,
    nombre: "Plan Platino",
    desc: "Sin deducible, copagos fijos mínimos en toda la red.",
    copagoEj: "$5 general",
    color: "bg-cyan-50 text-cyan-800 border-cyan-400",
  },
];
...
export function LandingPage() {
  ...
  return (
    <div className="bg-white min-h-screen text-slate-900 font-sans selection:bg-blue-200 overflow-x-hidden">
      <section className="min-h-[90vh] flex flex-col items-center justify-center px-6 text-center">
        ...
        >
          ...
          <p className="text-2xl md:text-3xl text-gray-500 max-w-3xl mx-auto mb-14 font-medium leading-relaxed">
            Baymax calcula tu copago exacto y encuentra el mejor hospital de tu
            red antes de que te atiendas.
          </p>
          <motion.button
          ...
          <div className="grid md:grid-cols-3 gap-16">
            <FadeInSection delay={0.1}>
              <div className="text-center flex flex-col items-center">
                ...
                <p className="text-gray-500 text-lg leading-relaxed">
                  Cuéntale a Baymax cómo te sientes en español o inglés. Él
                  determina la especialidad médica exacta.
                </p>
              </div>
            </FadeInSection>
            ...
            <FadeInSection delay={0.2}>
              <div className="text-center flex flex-col items-center">
                ...
                <p className="text-gray-500 text-lg leading-relaxed">
                  Baymax consulta tu plan de seguro en tiempo real, calculando
            ...
            <FadeInSection delay={0.3}>
              <div className="text-center flex flex-col items-center">
                ...
                <p className="text-gray-500 text-lg leading-relaxed">
                  Recibes un ranking de hospitales de la red ordenados por el
                  menor copago para tu bolsillo.
                </p>
              </div>
            </FadeInSection>
          </div>
      ...
      <section
        id="seccion-planes"
        className="py-40 px-6 border-t border-gray-100"
      >
        <div className="max-w-5xl mx-auto">
          <FadeInSection>
            <div className="text-center mb-20">
              <h2 className="text-2xl md:text-6xl font-bold tracking-tight mb-5">
                Selecciona tu plan para empezar.
              </h2>
              <p className="text-lg md:text-2xl text-gray-500 max-w-2xl mx-auto font-medium">
                Esta información es vital para que Baymax calcule tu cobertura
                exacta.
              </p>
            </div>

            <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-6 mb-10 md:mb-16">
              {planesDisponibles.map((plan) => (
                <motion.div
                  ...
                  className={`p-4 md:p-8 rounded-2xl md:rounded-3xl border-2 cursor-pointer transition-all flex flex-col justify-between h-full shadow-sm
                    ${
                ...
                >
                  <div>
                    ...
                    <p
                      className={`text-lg mb-6 leading-relaxed ${planSeleccionado.id === plan.id ? "opacity-90" : "text-gray-500"}`}
                    >
                      {plan.desc}
                    </p>
                  </div>
                  <div
                    className={`border-t pt-5 mt-auto ${planSeleccionado.id === plan.id ? "border-black/10" : "border-gray-100"}`}
                  >
                    <span className="text-xs uppercase tracking-wider font-semibold opacity-70">
                      Ejemplo Consulta General:
                    </span>
                    <span className="block font-extrabold text-lg md:text-2xl mt-1">
                      {plan.copagoEj}
                    </span>
                  </div>
                </motion.div>
            ...
            <div className="flex flex-col items-center gap-4 mt-10 mb-6">
              <p className="text-xl font-semibold text-slate-700">
                ¿Ya cumpliste tu deducible anual?
              </p>
              <div className="flex gap-3 w-full max-w-sm">
                <button
                  onClick={() => setDeducibleCumplido(false)}
                  className={`flex-1 px-4 py-3 rounded-full text-sm md:text-lg font-semibold border-2 transition-all ${
                    !deducibleCumplido
                ...
                <button
                  ...
                  className={`flex-1 px-4 py-3 rounded-full font-semibold text-sm md:text-lg border-2 transition-all ${
                    deducibleCumplido
            ...
            <div className="flex justify-center mt-8">
              <motion.button
                ...
                onClick={() =>
                  navigate("/chat", {
                    state: { planActivo: planSeleccionado, deducibleCumplido },
                  })
                }
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 md:py-6 px-6 md:px-14 rounded-full transition-colors shadow-2xl flex items-center gap-3 text-lg md:text-2xl w-full md:w-auto"
              >
